...
Fichier : deplace_niv_2.c

Auteur : Nicolle.B

Description : Gestion du deplacement du personnage et de la boucle mode MOYEN
...
void boucle_niv_2(arene table, int x, int y, char nom_j[50], char go){
    ...
    nb_point = nb_point_max + 9; /* On ajoute 9 (Personnage + 8 fantômes qui cachent les points en début de jeux */
    ...
    while (1){
        ...
        table[yfant1][xfant1] = fant1; /* Positionnement des fantômes 1,2,3,4,5,6,7 et 8 */
        ...
        if(table[y][x] == table[yfant1][xfant1] || table[y][x] == table[yfant2][xfant2] || table[y][x] == table[yfant3][xfant3] || table[y][x] == table[yfant4][xfant4] || table[y][x] == table[yfant5][xfant5] || table[y][x] == table[yfant6][xfant6] || table[y][x] == table[yfant7][xfant7] || table[y][x] == table[yfant8][xfant8]){
